...
export default function TicketLookup({useResource, resource, name, label, options, ...props}) {
            ...
            options={{
                ...
                table: {
                    ...
                    columns: [
                        ...
                        { key: 'isSeat', title: 'IsSeat', isSortable: true, render: (value) => value ? 'Да' : 'Нет' },
                        { key: 'price', title: 'Price', isSortable: true },
                        { key: 'state', title: 'State', isSortable: true },
