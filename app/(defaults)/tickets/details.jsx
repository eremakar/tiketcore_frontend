...
export default function TicketDetails({show, setShow, resourceName, resource, resourceData, orientation, type}) {
    return (
        <ResourceDetails resource={resource} show={show} setShow={setShow} resourceName={resourceName} resourceData={resourceData}>
            ...
            <FormField type="label" label="IsSeat" value={resourceData?.isSeat ? "Да" : "Нет"}/>
            <FormField type="label" label="Price" value={resourceData?.price}/>
            <FormField type="label" label="State" value={resourceData?.state}/>
