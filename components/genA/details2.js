...
const Details2 = ({show, setShow, resourceName, title, data, children, formatTitle, size = 'lg', closeTitle="Закрыть", closeButton = true, renderButtons,  ...props}) => {
    ...
    return show && <Transition appear show={show} as={Fragment}>
